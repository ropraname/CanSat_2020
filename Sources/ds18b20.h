 ...
 */
extern void ds18b20match(volatile uint8_t *port, volatile uint8_t *direction,
...
/**
 ...
 \note If provided ROM address pointer is NULL, ROM matching operation is skipped.
 */
extern uint8_t ds18b20convert(volatile uint8_t *port,
		volatile uint8_t *direction, volatile uint8_t *portin, uint8_t mask,
		uint8_t *rom);
...
/**
 ...
 \note If provided ROM address pointer is NULL, ROM matching operation is skipped.
 */
extern uint8_t ds18b20rsp(volatile uint8_t *port, volatile uint8_t *direction,
...
/**
 ...
 \note If provided ROM address pointer is NULL, ROM matching operation is skipped.
 */
extern uint8_t ds18b20wsp(volatile uint8_t *port, volatile uint8_t *direction,
...
/**
 ...
 \note If provided ROM address pointer is NULL, ROM matching operation is skipped.
 */
extern uint8_t ds18b20csp(volatile uint8_t *port, volatile uint8_t *direction,
		volatile uint8_t *portin, uint8_t mask, uint8_t *rom);
...
/**
 ...
 \note If provided ROM address pointer is NULL, ROM matching operation is skipped.
 */
extern uint8_t ds18b20read(volatile uint8_t *port, volatile uint8_t *direction,
		volatile uint8_t *portin, uint8_t mask, uint8_t *rom,
		int16_t *temperature);
 ...
 */
extern uint8_t ds18b20rom(volatile uint8_t *port, volatile uint8_t *direction,
		volatile uint8_t *portin, uint8_t mask, uint8_t *rom);
extern uint8_t ds18b20read_temp(int16_t *temp);
